...
public class FTPUtils {
     ...
     */
    private FTPUtils(String host, String username, String password, String ftpBasePath) {
     ...
     * @param ftpBasePath 初始化时ftp服务器路径
     */
    private FTPUtils(String host, int port, String username, String password, String charset, String ftpBasePath) {
     ...
     */
    public static FTPUtils createFtpCli(String host, String username, String password, String ftpBasePath) {
        return new FTPUtils(host, username, password, ftpBasePath);
    }
    ...
    public static FTPUtils createFtpCli(String host, int port, String username, String password, String charset, String ftpBasePath) {
        return new FTPUtils(host, port, username, password, charset, ftpBasePath);
    }
